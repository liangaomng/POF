...
do
  ...
  do
    ...
    do
      ...
      export pid_en=no
      dat="${base_dat}_trunk_${trunk_net}_${wavelet}alpha_${alpha}_mode_${modes}seed_${seed}_pid_${pid_en}"
      ...
      python Operator/Train_NCHD.py  --Trunk $trunk_net --alpha $alpha --modes $level --seed $seed --dat $dat --epoch $Train_epoch --data_folder $Data_set --pid $pid_en
